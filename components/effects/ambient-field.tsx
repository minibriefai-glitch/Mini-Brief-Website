...
// Curated to ~14 evenly-spread dots (was 24). Each is a fixed, perpetually
// animating layer that the compositor must touch every scroll frame, so the
// count is kept lean — the field still reads as continuous, at ~40% less
// always-on compositing cost.
