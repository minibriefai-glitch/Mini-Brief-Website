...
export function LiveDemo() {
  ...
  // Auto-boot the demo as it scrolls into view so it feels live on arrival.
  // Skipped on data-saver connections and small screens (it's a 2 MB desktop
  // bundle) — those visitors get the tap-to-launch poster instead.
  useEffect(() => {
